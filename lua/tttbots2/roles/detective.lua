...
local detective = TTTBots.RoleBuilder.DetectiveLike("detective")
detective:SetAlliedRoles({ detective = true, deputy = true, sheriff = true, sniffer = true, priest = true, survivalist = true, innocent = true })
