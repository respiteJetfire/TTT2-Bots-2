...
local LoadLang = function()
    ...
    Line("I found {{corpse}}'s corpse.", A.Default)
    Line("There's a dead player here.", A.Default)
    Line("{{corpse}} is dead over here.", A.Default)
    Line("I see a dead person.", A.Default)
    Line("Found {{corpse}}, they need help.", A.Default)

    Line("yo, {{corpse}} is knocked out", A.Casual)
    Line("hey, {{corpse}} is dead over here", A.Casual)
    Line("{{corpse}} is taking a nap lol", A.Casual)
    Line("found {{corpse}}'s corpse, lol", A.Casual)
    Line("uh, {{corpse}} is out cold", A.Casual)

    Line("{{corpse}}'s out cold.", A.Bad)
    Line("Found {{corpse}} knocked out.", A.Bad)
    Line("{{corpse}}'s dead, typical.", A.Bad)
    Line("Look at this fool, {{corpse}} is dead.", A.Bad)
    Line("Another one bites the dust, {{corpse}}.", A.Bad)

    Line("uhh, why is {{corpse}} dead?", A.Dumb)
    Line("hey, {{corpse}}'s not moving", A.Dumb)
    Line("is {{corpse}} dead or what?", A.Dumb)
    Line("uh oh, {{corpse}}'s not awake", A.Dumb)
    Line("why is {{corpse}} lying dead?", A.Dumb)

    Line("{{corpse}}'s dead, idiots.", A.Hothead)
    Line("Found {{corpse}} knocked out.", A.Hothead)
    Line("{{corpse}}'s out, what a joke.", A.Hothead)
    Line("Look at this idiot, {{corpse}} is dead.", A.Hothead)
    Line("{{corpse}}'s dead, figures.", A.Hothead)

    Line("I found {{corpse}}, they need help.", A.Nice)
    Line("{{corpse}} is dead here, let's help.", A.Nice)
    Line("{{corpse}} is dead, let's assist.", A.Nice)
    Line("I see {{corpse}}'s corpse, let's help them.", A.Nice)
    Line("Found {{corpse}} who needs our help.", A.Nice)

    Line("I found {{corpse}}'s body.", A.Stoic)
    Line("{{corpse}} is dead here.", A.Stoic)
    Line("{{corpse}} is dead.", A.Stoic)
    Line("I see {{corpse}}'s remains.", A.Stoic)
    Line("Found {{corpse}}, deceased.", A.Stoic)

    Line("Found {{corpse}}'s corpse, team.", A.Teamer)
    Line("{{corpse}} is dead here, team.", A.Teamer)
    Line("{{corpse}} is out cold, team.", A.Teamer)
    Line("I see {{corpse}}'s body, team.", A.Teamer)
    Line("Found {{corpse}}, needs help, team.", A.Teamer)

    Line("Found {{corpse}}'s body, let's revive.", A.Tryhard)
    Line("{{corpse}} is dead, let's get them up.", A.Tryhard)
    Line("{{corpse}}'s out cold, let's revive them.", A.Tryhard)
    Line("I see {{corpse}}'s body, let's help.", A.Tryhard)
    Line("Found {{corpse}}, let's revive, let's go.", A.Tryhard)

    RegisterCategory("ReportCorpse", P.IMPORTANT, "When a bot has finished investigating a dead body and reports the findings.")
    Line("I've identified the body: {{corpse}}.", A.Default)
    Line("{{corpse}} is confirmed dead.", A.Default)
    Line("Body found: {{corpse}}.", A.Default)
    Line("I checked the body, it's {{corpse}}.", A.Default)
    Line("I've ID'd {{corpse}}'s corpse.", A.Default)

    Line("checked the body, it's {{corpse}}", A.Casual)
    Line("yep, that's {{corpse}}, dead lol", A.Casual)
    Line("{{corpse}} is done for lol", A.Casual)
    Line("id'd {{corpse}}'s body", A.Casual)
    Line("rip {{corpse}} lmao", A.Casual)

    Line("Checked {{corpse}}'s corpse. Dead.", A.Bad)
    Line("{{corpse}} is dead. Obviously.", A.Bad)
    Line("ID'd the body, it's {{corpse}}. Big surprise.", A.Bad)
    Line("{{corpse}} is confirmed dead. Pathetic.", A.Bad)
    Line("{{corpse}}'s body confirmed.", A.Bad)

    Line("uhh, it's {{corpse}}'s body", A.Dumb)
    Line("that's {{corpse}} I think?", A.Dumb)
    Line("I checked and it's {{corpse}}", A.Dumb)
    Line("{{corpse}} is dead I think", A.Dumb)
    Line("is that {{corpse}}? yeah, dead.", A.Dumb)

    Line("{{corpse}} confirmed dead, idiots!", A.Hothead)
    Line("It's {{corpse}}'s body! Obviously!", A.Hothead)
    Line("{{corpse}} is dead, checked the body!", A.Hothead)
    Line("ID'd {{corpse}}'s corpse!", A.Hothead)
    Line("{{corpse}} is gone, body confirmed!", A.Hothead)

    Line("I've ID'd {{corpse}}'s body. Let's find who did this.", A.Nice)
    Line("{{corpse}} is confirmed deceased. Let's avenge them.", A.Nice)
    Line("Poor {{corpse}}. Body identified.", A.Nice)
    Line("I've checked {{corpse}}'s body. Rest in peace.", A.Nice)
    Line("{{corpse}} has been confirmed dead. Stay safe everyone.", A.Nice)

    Line("Body identified: {{corpse}}.", A.Stoic)
    Line("{{corpse}} confirmed dead.", A.Stoic)
    Line("I have identified {{corpse}}'s remains.", A.Stoic)
    Line("{{corpse}}'s body has been found.", A.Stoic)
    Line("Confirmed: {{corpse}} is deceased.", A.Stoic)

    Line("ID'd {{corpse}}'s body, team.", A.Teamer)
    Line("{{corpse}} confirmed dead, team.", A.Teamer)
    Line("Body found: {{corpse}}, team.", A.Teamer)
    Line("Checked the body, it's {{corpse}}, team.", A.Teamer)
    Line("{{corpse}} is gone, confirmed, team.", A.Teamer)

    Line("Body confirmed: {{corpse}}. Time to investigate.", A.Tryhard)
    Line("{{corpse}} ID'd. Let's find the killer.", A.Tryhard)
    Line("{{corpse}} is confirmed KIA.", A.Tryhard)
    Line("ID'd {{corpse}}'s body. Moving on.", A.Tryhard)
    Line("Confirmed {{corpse}}'s death. Proceeding.", A.Tryhard)
