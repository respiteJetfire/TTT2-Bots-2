...
--- This includes traitors, necromancers, jackals, infected hosts, serial killers, etc.
--- Excludes KOS-by-all roles like Doomguy (they're publicly hostile, no point blending in).
---@param bot Bot
